<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="sviletovi.aspx.cs" Inherits="aerodrom.sviletovi" %>
     ...
     <div class="col-md-7">
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="row">
                      <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:aerodromDBConnectionString %>" SelectCommand="SELECT [id_let], [mesto_polaska], [mesto_dolaska], [datum_leta], [broj_presedanja], [broj_mesta] FROM [let_tbl]" ></asp:SqlDataSource>
                     <div class="col">
